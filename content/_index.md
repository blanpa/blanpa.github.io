...
<p class="home-tagline">I help manufacturers turn <strong>shop-floor signals</strong> into <strong>cloud-ready data</strong> — open-source Node-RED modules for OPC-UA, Siemens S7, Allen-Bradley CIP, NATS and Kafka, from edge gateway to dashboard.</p>
